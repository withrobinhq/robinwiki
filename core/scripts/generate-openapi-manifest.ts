...
const routes: RouteSpec[] = [
  ...
  { method: 'GET', path: '/admin/graph/stats', operationId: 'getGraphStats', summary: 'Read-only graph and pipeline observability snapshot', tags: ['Admin'], auth: 'session', responses: { '200': { description: 'Graph and pipeline stats snapshot' }, '500': { description: 'Query failed', schemaName: 'errorResponseSchema' } } },
